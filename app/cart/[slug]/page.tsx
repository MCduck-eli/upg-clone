...
export default function ProductPage() {
    ...
    if (!product) {
        return (
            <div className="w-full flex justify-center items-center h-96 text-red-500">
                Product not found
            </div>
        );
    }
            ...
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div className="lg:grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    ...
                    <div className="flex justify-between gap-10">
                        <p className="mb-8 text-2xl text-pink-500 font-semibold">
                            {product.price} UZS
                        </p>
                        <div className="w-2.5  relative top-2">
                            <StarRate />
                        </div>
                    </div>
                    ...
                    <span className="inline-flex mb-4 mt-2 justify-end text-pink-500 bg-pink-500/20 items-center bg-brand-softer border border-brand-subtle text-fg-brand-strong text-xs font-medium px-1.5 py-0.5 rounded-sm">
                        <svg
